...
<style lang="css">
  ...
  :global(.adsr2-configure-step-control-panel .control-panel > .control-panel-container > :first-child) {
    width: 10% !important;
  }

  :global(.adsr2-configure-step-control-panel .control-panel > .control-panel-container > :nth-child(3)) {
    width: 37% !important;
  }
</style>
